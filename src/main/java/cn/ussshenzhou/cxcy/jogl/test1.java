...
public class test1 {
    ...
    public static void main(final String[] args) throws Exception {
        ...
        try {
            final SimpleResourceLocator srl = new SimpleResourceLocator(ResourceLocatorTool.getClassPathResource(
                    com.ardor3d.example.canvas.test1.class, "com/ardor3d/example/media/"));
    ...
    private static MouseCursor createMouseCursor(final AWTImageLoader awtImageLoader, final String resourceName)
        ...
        final com.ardor3d.image.Image image = awtImageLoader.load(
                ResourceLocatorTool.getClassPathResourceAsStream(com.ardor3d.example.canvas.test1.class, resourceName), false);
